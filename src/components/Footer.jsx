  ...
  return (
    <footer className="mt-auto">
      <div className="w-full background-gradiente p-5 ">
        <div className="w-[95%] mx-auto flex gap-2 items-center justify-between">
          ...
          <div>
            <div className="flex items-center w-full gap-3 justify-center">
              <div className="hover:bg-[#7daa92] hover:text-white flex items-center rounded-full p-2 cursor-pointer">
            ...
            <p className="text-white">
              Copyright © 2023 Ananda. Todos los derechos reservados
            </p>
          </div>
        </div>
      </div>
